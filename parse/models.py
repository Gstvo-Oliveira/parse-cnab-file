...
class ParseCnab(models.Model):
    ...
    type = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(9)])
    ...
    cpf = models.TextField(
        max_length=11, validators=[MinLengthValidator(11), MaxLengthValidator(11)]
    )
    card = models.TextField(
        max_length=12, validators=[MinLengthValidator(12), MaxLengthValidator(12)]
    )
    hour = models.TextField(
        max_length=6, validators=[MinLengthValidator(6), MaxLengthValidator(6)]
    )
